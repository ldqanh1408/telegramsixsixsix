...
@Component
class IssueCommentEventHandler implements GitHubEventHandler {

    private final EventFormatter formatter;
    private final NotificationService notifications;

    public IssueCommentEventHandler(@Qualifier("issueCommentEventFormatter") EventFormatter formatter, NotificationService notifications) {
    ...
    public boolean supports(String event) {
        return "issue_comment".equals(event);
    }
