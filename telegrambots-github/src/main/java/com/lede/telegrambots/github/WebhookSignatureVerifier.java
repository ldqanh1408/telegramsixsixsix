...
/**
 * Port for verifying an inbound webhook signature against a shared secret.
 *
 * <p>Consumers depend on this interface so the verification algorithm can be swapped
 * or test-doubled without touching webhook-handling code (Dependency Inversion).</p>
 */
