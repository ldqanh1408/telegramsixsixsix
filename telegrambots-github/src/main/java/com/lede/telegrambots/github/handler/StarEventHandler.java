...
@Component
class StarEventHandler implements GitHubEventHandler {

    private final EventFormatter formatter;
    private final NotificationService notifications;

    public StarEventHandler(@Qualifier("starEventFormatter") EventFormatter formatter, NotificationService notifications) {
