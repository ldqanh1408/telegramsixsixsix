...
/**
 * GitHub-flavoured HMAC-SHA256 implementation of {@link WebhookSignatureVerifier}.
 *
 * <p>Verifies GitHub's {@code X-Hub-Signature-256} header against the raw body using
 * the per-bot secret, with a constant-time comparison to avoid timing attacks.</p>
 */
@Component
class HmacSha256SignatureVerifier implements WebhookSignatureVerifier {
