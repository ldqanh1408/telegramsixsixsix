...
@Component
class WorkflowRunEventHandler implements GitHubEventHandler {

    private final EventFormatter formatter;
    private final NotificationService notifications;

    public WorkflowRunEventHandler(@Qualifier("workflowRunEventFormatter") EventFormatter formatter, NotificationService notifications) {
    ...
    public boolean supports(String event) {
        return "workflow_run".equals(event);
    }
