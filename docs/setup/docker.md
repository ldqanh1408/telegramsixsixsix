...
Telegram và GitHub cần HTTPS public. Dự án có tích hợp sẵn dịch vụ ngrok trực tiếp trong Docker Compose. Xem hướng dẫn chi tiết cách cấu hình và lấy URL HTTPS công khai tại [webhook.md](webhook.md).
